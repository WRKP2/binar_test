...
class MY_Controller extends CI_Controller {
    ...
    protected function render($view_path, $data, $template = 'main') {
        ...
        if (isset($view_path)) {
            $this->data['content'] .= $this->load->view($view_path, $data, true);  //load the view
        }
 		
        $this->load->view("template/$template.template.php", $this->data);  //load the template
    }
