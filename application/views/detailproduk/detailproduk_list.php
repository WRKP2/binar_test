...
<!-- ADMINLTE-->
    ...
    var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "detailproduk/json", "type": "POST"},
                    columns: [
                    {
                    "data": "idx",
                            "orderable": false
                    }, {"data": "idproduk"},{"data": "idkategoriproduk"},{"data": "juduldetailproduk"},{"data": "diskripsiproduk"},{"data": "rate"},{"data": "ratediscount"},{"data": "rancode"},{"data": "tglinsert"},{"data": "tglupdate"},{"data": "idpegawai"},{"data": "kapasitas"},{"data": "standartpemakaian"},{"data": "standart"},{"data": "idsatuan"},{"data": "isfavorit"},{"data": "idmember"},
                    {
                    "data" : "action",
                            "orderable": false,
