...
<html>
    <head>
        <title>Membervoucher List</title>
...
<!-- ADMINLTE-->
    ...
    var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "membervoucher/json", "type": "POST"},
                    columns: [
                    {
                    "data": "idx",
                            "orderable": false
                    }, {"data": "idmember"},{"data": "idvoucher"},{"data": "idproduk"},{"data": "tglpakai"},{"data": "isdipakai"},{"data": "idjenisvoucher"},{"data": "idreveral"},{"data": "isdipakaireveral"},
                    {
                    "data" : "action",
                            "orderable": false,
