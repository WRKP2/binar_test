...
<!-- ADMINLTE-->
    ...
    var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "voucher/json", "type": "POST"},
                    columns: [
                    {
                    "data": "idx",
                            "orderable": false
                    }, {"data": "voucher"},{"data": "nominal"},{"data": "prosentase"},{"data": "tglberlakudari"},{"data": "tglberlakusampai"},{"data": "idmember"},{"data": "isterpakai"},{"data": "tglpakai"},{"data": "linkimage"},{"data": "idproduk"},{"data": "jumlahmaxpengguna"},{"data": "penjelasan"},{"data": "idjenisvoucher"},{"data": "aktifjmlrekomendasi"},{"data": "dayvoucher"},
                    {
                    "data" : "action",
                            "orderable": false,
