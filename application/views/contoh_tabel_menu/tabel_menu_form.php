...
<!-- ADMINLTE-->
	    ...
	    <div class="form-group">
            <label for="varchar">Is Main Menu <?php echo form_error('is_main_menu') ?></label>
	    ...
	    <a href="<?php echo site_url('contoh_tabel_menu') ?>" class="btn btn-default">Cancel</a>
	</form>
