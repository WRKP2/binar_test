...
<!-- ADMINLTE-->
    ...
    var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "member/json", "type": "POST"},
                    columns: [
                    {
                    "data": "idx",
                            "orderable": false
                    }, {"data": "Nama"},{"data": "Alamat"},{"data": "NoTelpon"},{"data": "idtoken"},{"data": "email"},{"data": "tglinsert"},{"data": "isblokir"},{"data": "idjenismember"},{"data": "password"},{"data": "photoUrl"},{"data": "tokenmember"},
                    {
                    "data" : "action",
                            "orderable": false,
