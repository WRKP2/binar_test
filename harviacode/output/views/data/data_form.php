<h2 style="margin-top:0px">Data <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="gabung">Gabung <?php echo form_error('gabung') ?></label>
            <input type="text" class="form-control" name="gabung" id="gabung" placeholder="DD/MM/YYYY" value="<?php echo $gabung; ?>" /><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        </div>
