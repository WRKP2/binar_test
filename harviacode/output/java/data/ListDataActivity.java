...
package testk24willybrodusrangga.org.testk24willybrodusrangga.data;
...
import testk24willybrodusrangga.org.testk24willybrodusrangga.R;
...
DataCLASS dataclass = xLsItem.get(position);
                if (!dataclass.getID().trim().equals("")) {
...
@Override
    ...
    }//TODO AsyncTask GET listListDataActivity
...
public void SetListListDataActivity() {
        data = new Adapterdata(xLsItem); 
        rv.setAdapter(data);
        rv.setLayoutManager(llm);

    }//TODO AsyncTask DeletListDataActivity
